...
class Orbit:
    ...
    def __init__(self, x0, fixedValue, system, tau=None, comment="True"):
        # dynamical system
        self.system = system
        # stability index
        self.stability = None
        ...
        try:
            outData = NumericalMethods.diffCorrections(x0, self.system.mu, Orbit.accuracy, fixedValue, tau=tau)
    ...
    def getClosestNRHO(self, direction=None):
        ...
        # starts pseudo-arclength continuation method
            ...
            while self.stability > Orbit.stabilityCriteria:
                ...
                outData = NumericalMethods.diffCorrections(self.x0, self.system.mu, Orbit.accuracy, method=0,
                                                           returnData=True)
                x_n = outData[0]
                tau_n = outData[1]
                phi = outData[2]
...
class InitialGuess:
    ...
    def __init__(self, dynamicalSystem, lagrangian, family, fixedValue, value):
        ...
        #outData = NumericalMethods.diffCorrections(x0, dynamicalSystem.mu, 1.0e-8, fixedValue, tau=(2*np.pi)/(lam*omega)/2)
        self.x0 = x0#outData[0:6]
